 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://tutorial.soap.webservice/", wsdlLocation = "http://localhost:8080/Calculator/CalculatorWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://tutorial.soap.webservice/", "CalculatorWebService");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://tutorial.soap.webservice/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tutorial.soap.webservice/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
